...
/*------------------- Rutas del CRUD --------------------------------------*/   
     ...
     Route::resource('post', PostController::class);               //esta forma hay que habilitar el controlador al inicio del código "use App\Http\Controllers\Dashboard\PostController;;"
